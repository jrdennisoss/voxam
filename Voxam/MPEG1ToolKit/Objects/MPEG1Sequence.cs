...
namespace Voxam.MPEG1ToolKit.Objects
{
    ...
    {
        public const byte BEGIN_STREAM_ID_TYPE = 0xB3;
        public const byte END_STREAM_ID_TYPE = 0xB7;
        ...
        public MPEG1Sequence(IMPEG1Object parent, MPEG1ObjectSource source)
        {
            _parent = parent;
            _source = source;
        }
        ...
        public static MPEG1Sequence Marshal(MPEG1StreamObjectIterator iter, IMPEG1Object parent = null)
        {
            ...
            if (iter.MPEGObjectType != BEGIN_STREAM_ID_TYPE) return null;
            ...
            return new MPEG1Sequence(parent, new MPEG1ObjectSource(iter));
        }
        ...
        public byte StreamIdType => BEGIN_STREAM_ID_TYPE;
    }
}
