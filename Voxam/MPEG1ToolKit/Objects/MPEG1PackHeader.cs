...
{
    public class MPEG1PackHeader : IMPEG1Object
    {
        public const byte STREAM_ID_TYPE = 0xBA;

        private readonly IMPEG1Object _parent;
        private readonly MPEG1ObjectSource _source;

        public MPEG1PackHeader(IMPEG1Object parent, MPEG1ObjectSource source)
        {
            _parent = parent;
            _source = source;
        }

        public static MPEG1PackHeader Marshal(MPEG1StreamObjectIterator iter, IMPEG1Object parent = null)
        {
            ...
            return new MPEG1PackHeader(parent, new MPEG1ObjectSource(iter));
        }

        public string Name => "MPEG-1 Pack Header";
