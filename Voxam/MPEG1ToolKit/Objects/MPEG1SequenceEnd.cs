...
{
    public class MPEG1SequenceEnd : IMPEG1Object
    {
        public const byte STREAM_ID_TYPE = 0xB7;

        private readonly IMPEG1Object _parent;
        private readonly MPEG1ObjectSource _source;

        public MPEG1SequenceEnd(IMPEG1Object parent, MPEG1ObjectSource source)
        {
            _parent = parent;
            _source = source;
        }

        public static MPEG1SequenceEnd Marshal(MPEG1StreamObjectIterator iter, IMPEG1Object parent = null)
        {
            if (!iter.MPEGObjectValid) return null;
            if (iter.MPEGObjectType != STREAM_ID_TYPE) return null;
            return new MPEG1SequenceEnd(parent, new MPEG1ObjectSource(iter));
        }

        public string Name => "MPEG-1 Sequence End";
